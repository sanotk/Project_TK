...
//        style.background = new TextureRegionDrawable(Assets.instance.uiBlue.findRegion("window_01"));
        ...
        Label text3 = new Label("โดยจะมีชาร์จคอนโทรลเลอร์ควบคุมการชาร์จไฟจากโซล่าเซลล์ไปยังแบตเตอรี่", skin);
        Label text4 = new Label("ชาร์จคอนโทรลเลอร์ยังทำหน้าที่นำไฟจ่ายไปยังอุปกรณ์ไฟฟ้าต่างๆ", skin);
        Label text5 = new Label("ไฟฟ้าที่ผลิตได้จะเป็นไฟฟ้ากระแสตรง", skin);
        Label text6 = new Label("ดังนั้นเนื่องจากอุปกรณ์ไฟฟ้าภายในบ้านใช้ไฟฟ้ากระแสสลับ จึงต้องต่อผ่านเครื่องอินเวอร์เตอร์เพื่อเปลี่ยนเป็นไฟฟ้ากระแสสลับก่อน", skin);

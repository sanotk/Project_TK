...
//        style.background = new TextureRegionDrawable(Assets.instance.uiBlue.findRegion("window_01"));
        ...
        Label text3 = new Label("โดยจะให้ผู้เล่นตัดสินใจว่าจะตอบรับหรือปฎิเสธคำร้องขอนั้นตามความเหมาะสม", skin);
        ...
        Label text5 = new Label("หากปฎิเสธประชาชนจะอยู่กลับที่ พร้อมทั้งค่าความพอใจจะลดลงตามความสำคัญของกิจกรรมนั้น", skin);

...
public class TiledCollisionCheckItem5 implements CollisionCheck {

    private TiledMapTileLayer tileLayer;
    private Rectangle rectObject;
    private String property;

    public TiledCollisionCheckItem5(Rectangle rectObject, TiledMapTileLayer tileLayer) {
        this(rectObject, tileLayer, "door");
    }

    public TiledCollisionCheckItem5(Rectangle rectObject, TiledMapTileLayer tileLayer, String property) {

...
public class Citizen6 extends Citizen {

	public static final int MAX_SPEED = 100;
	public static final float SCALE = 0.5f;

    public static final float INITIAL_GOAL_X = 800;
    public static final float INITIAL_GOAL_Y = 800;

    public Citizen6(TiledMapTileLayer mapLayer, Player player) {
    ...
    public Citizen6(TiledMapTileLayer mapLayer, Player player,float P_X, float P_Y) {
